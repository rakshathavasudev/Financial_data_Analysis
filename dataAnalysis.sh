...
echo "Analysis of standard deviation over the years gives us an idea about how can the financial matters can dealt without risk and with more profit for the benefit of the country. "
...
awk -F, '$1<1947' extractData.csv
echo "The forex rate has increased after the independece which is not a good sign for a developing economy"
#read year
